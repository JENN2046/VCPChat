...
const trayManager = (function () {
    ...
    const VCHAT_APPS = [
        ...
        { id: 'vchat-app-photo-studio', name: '影像工作台', icon: 'photoStudio', action: 'open-photo-studio-window' },
    ...
    const SVG_ICONS = {
        ...
        photoStudio: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7a2 2 0 0 1 2-2h2l1.2-2h5.6L16 5h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2Z"/><circle cx="12" cy="11.5" r="3.5"/><path d="M9 21h6"/></svg>`,
