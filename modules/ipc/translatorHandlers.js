...
async function createOrFocusTranslatorWindow() {
    ...
    const translatorUrl = `file://${path.join(PROJECT_ROOT, 'Desktopmodules', 'legacy', 'Translatormodules', 'translator.html')}?vcpServerUrl=${encodeURIComponent(vcpServerUrl)}&vcpApiKey=${encodeURIComponent(vcpApiKey)}`;
