...
function createCatalog(ops) {
    return {
        ...
        photoStudioOpen: query(() => ops.invoke('photo-studio-open')),
        photoStudioGetDashboard: query(() => ops.invoke('photo-studio-get-dashboard')),
        photoStudioListProjects: query((filters = {}) => ops.invoke('photo-studio-list-projects', filters)),
        photoStudioGetProject: query((projectId) => ops.invoke('photo-studio-get-project', projectId)),
        photoStudioRunAction: query((request = {}) => ops.invoke('photo-studio-run-action', request)),
        photoStudioRefreshScene: query((request = {}) => ops.invoke('photo-studio-refresh-scene', request)),
...
const ALLOWED_KEYS = [
    ...
    "desktopPush",
      ...
      "openDesktopWindow",
      "photoStudioOpen",
      "photoStudioGetDashboard",
      "photoStudioListProjects",
      "photoStudioGetProject",
      "photoStudioRunAction",
      "photoStudioRefreshScene",
      "windowReady",
